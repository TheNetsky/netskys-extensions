...
const Mangahub_1 = require("../Mangahub/Mangahub");
describe('Mangahub Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new Mangahub_1.Mangahub(cheerio_1.default);
     ...
     */
    var mangaId = "forced-to-become-the-villain-s-son-in-law";
    ...
    it("Testing home page results for hot update", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("Testing home page results for hot manga", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "hot_manga", {}, 1);
        expect(results, "No results whatsoever for this section").to.exist;
        expect(results, "No results whatsoever for this section").to.exist;
        let data = results[0];
        expect(data.id, "No ID present").to.exist;
    ...
    it("Testing search", () => __awaiter(this, void 0, void 0, function* () {
        ...
        let search = yield wrapper.searchRequest(source, testSearch, { page: 0 });
    ...
    it("Testing Home-Page aquisition", () => __awaiter(this, void 0, void 0, function* () {
        ...
        expect(homePages[1], "No hott manga section available").to.exist;
    ...
    */
    it("Testing Notifications", () => __awaiter(this, void 0, void 0, function* () {
        let updates = yield wrapper.filterUpdatedManga(source, new Date("2021-3-29"), [mangaId]);
