...
const MangaBuddy_1 = require("../MangaBuddy/MangaBuddy");
describe('MangaBuddy Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new MangaBuddy_1.MangaBuddy(cheerio_1.default);
    ...
    it("Testing home page results for latest update titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "latest_update", {}, 1);
    ...
    it("Testing Notifications", () => __awaiter(this, void 0, void 0, function* () {
        let updates = yield wrapper.filterUpdatedManga(source, new Date("2021-4-15"), [mangaId, "my-wife-is-a-demon-queen"]);
