...
const MangaJar_1 = require("../MangaJar/MangaJar");
describe('MangaJar Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new MangaJar_1.MangaJar(cheerio_1.default);
    ...
    it("Testing home page results for hot update titles", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("Testing home page results for new trending titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "new_trending", {}, 1);
        expect(results, "This section does not exist").to.exist;
        expect(results, "No results whatsoever for this section").to.be.not.empty;
        let data = results[0];
        expect(data.id, "No ID present").to.exist;
    ...
    it("Testing home page results for popular titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "popular_manga", {}, 1);
        expect(results, "This section does not exist").to.exist;
        expect(results, "No results whatsoever for this section").to.be.not.empty;
        let data = results[0];
        expect(data.id, "No ID present").to.exist;
    ...
    it("Testing home page results for new manga titles", () => __awaiter(this, void 0, void 0, function* () {
