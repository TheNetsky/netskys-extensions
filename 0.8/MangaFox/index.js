...
class MangaFox {
    ...
    async getChapterDetails(mangaId, chapterId) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        return (0, MangaFoxParser_1.parseChapterDetails)($, mangaId, chapterId, request.url, this);
    }
...
},{"./MangaFoxHelper":63,"./MangaFoxParser":64,"@paperback/types":61}],63:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
