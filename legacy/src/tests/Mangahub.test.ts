...
describe('Mangahub Tests', function () {
    ...
    it("Testing home page results for hot update", async () => {
    ...
    it("Testing home page results for hot manga", async () => {
    ...
    it("Testing home page results for latest updated titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "latest_updates", {}, 1)
    ...
    */
    it("Testing Notifications", async () => {
        ...
        let updates = await wrapper.filterUpdatedManga(source, new Date("2021-3-29"), [mangaId])
