...
var _Sources = (() => {
  ...
  var parseMangaDetails = ($, mangaId) => {
    ...
    const title = (0, import_html_entities.decode)($("h1.entry-title").first().text().trim());
    const artist = (0, import_html_entities.decode)($("p:contains(Cosplayer:)").text().trim().replace("Cosplayer:", "").trim());
