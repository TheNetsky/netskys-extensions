...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Ososedki = exports.OsosedkiInfo = void 0;
...
class Ososedki {
    ...
    getMangaShareUrl(mangaId) { return `${OS_DOMAIN}/${mangaId}`; }
    async getMangaDetails(mangaId) {
        ...
        return (0, OsosedkiParser_1.parseMangaDetails)($, mangaId);
    }
    async getChapters(mangaId) {
        return (0, OsosedkiParser_1.parseChapters)(mangaId);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, OsosedkiParser_1.parseChapterDetails)($, mangaId, chapterId);
    }
    async getHomePageSections(sectionCallback) {
        ...
        for (const section of sections) {
            ...
            promises.push(this.requestManager.schedule(section.request, 1)
                ...
                this.CloudFlareError(response.status);
                const $ = this.cheerio.load(response.data);
                const items = (0, OsosedkiParser_1.parseHomeSections)($, OS_DOMAIN, section.sectionID.id);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        const manga = (0, OsosedkiParser_1.parseHomeSections)($, OS_DOMAIN, homepageSectionId);
    ...
    async getSearchTags() {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        return (0, OsosedkiParser_1.parseTags)($);
    }
    async getSearchResults(query, metadata) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        const manga = (0, OsosedkiParser_1.parseHomeSections)($, OS_DOMAIN, '');
        metadata = { page: page + 1 };
        return App.createPagedResults({
            results: manga,
            metadata
...
exports.Ososedki = Ososedki;

},{"./OsosedkiParser":69,"@paperback/types":59}],69:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const parseHomeSections = ($, OS_DOMAIN, sectionID) => {
    const collectedIds = [];
    const itemArray = [];
    switch (sectionID) {
        case 'random':
