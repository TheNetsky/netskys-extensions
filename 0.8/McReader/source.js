...
var _Sources = (() => {
  ...
  var parseMangaDetails = ($, mangaId) => {
    const titles = [];
    titles.push((0, import_html_entities.decode)($("img", "div.fixed-img").attr("alt")?.trim() ?? ""));
    ...
    const description = (0, import_html_entities.decode)($("p.description > br")[1]?.nextSibling.nodeValue.trim() ?? "");
    const arrayTags = [];
