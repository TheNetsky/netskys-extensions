...
const MangaKatana_1 = require("../MangaKatana/MangaKatana");
describe('MangaKatana Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new MangaKatana_1.MangaKatana(cheerio_1.default);
     ...
     */
    var mangaId = "eleceed.115"; // Mashle
