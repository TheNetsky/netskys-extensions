...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HentaiCosplay = exports.HentaiCosplayInfo = void 0;
...
class HentaiCosplay extends types_1.Source {
    constructor() {
        super(...arguments);
    ...
    getMangaShareUrl(mangaId) { return `${HC_DOMAIN}/image/${mangaId}`; }
    ...
    async getChapterDetails(mangaId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, HentaiCosplayParser_1.parseChapterDetails)($, mangaId);
    }
    async getHomePageSections(sectionCallback) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        (0, HentaiCosplayParser_1.parseHomeSections)($, sectionCallback);
    }
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        metadata = !(0, HentaiCosplayParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
...
exports.HentaiCosplay = HentaiCosplay;

},{"./HentaiCosplayParser":69,"@paperback/types":59}],69:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.isLastPage = exports.parseViewMore = exports.parseHomeSections = exports.parseChapterDetails = exports.parseChapters = exports.parseMangaDetails = void 0;
const types_1 = require("@paperback/types");
const entities = require("entities");
const parseMangaDetails = ($, mangaId) => {
    const title = decodeHTMLEntity($('span#title > h2').text().trim());
...
const parseChapterDetails = ($, mangaId) => {
    const pages = [];
