...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Mitaku = exports.MitakuInfo = void 0;
...
class Mitaku {
    ...
    getMangaShareUrl(mangaId) { return `${MT_DOMAIN}/?p=${mangaId}`; }
    async getMangaDetails(mangaId) {
        ...
        return (0, MitakuParser_1.parseMangaDetails)($, mangaId);
    }
    async getChapters(mangaId) {
        return (0, MitakuParser_1.parseChapters)(mangaId);
    }
    async getChapterDetails(mangaId, chapterId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, MitakuParser_1.parseChapterDetails)($, mangaId, chapterId);
    }
    async getHomePageSections(sectionCallback) {
        ...
        for (const section of sections) {
            ...
            promises.push(this.requestManager.schedule(section.request, 1)
                ...
                this.CloudFlareError(response.status);
                const $ = this.cheerio.load(response.data);
                const items = (0, MitakuParser_1.parseHomeSections)($);
    ...
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        const manga = (0, MitakuParser_1.parseHomeSections)($);
        metadata = !(0, MitakuParser_1.isLastPage)($) ? { page: page + 1 } : undefined;
...
exports.Mitaku = Mitaku;

},{"./MitakuParser":69,"@paperback/types":59}],69:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
