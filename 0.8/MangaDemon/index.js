...
class MangaDemon {
    ...
    getMangaShareUrl(mangaId) { return `${MD_DOMAIN}/manga/${mangaId}`; }
    async getMangaDetails(mangaId) {
        ...
        return (0, MangaDemonParser_1.parseMangaDetails)($, mangaId);
    }
    async getChapters(mangaId) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        return (0, MangaDemonParser_1.parseChapters)($, mangaId);
    }
    ...
    async getHomePageSections(sectionCallback) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        (0, MangaDemonParser_1.parseHomeSections)($, sectionCallback);
    }
    async getViewMoreItems(homepageSectionId, metadata) {
        ...
        this.CloudFlareError(response.status);
        const $ = this.cheerio.load(response.data);
        const manga = (0, MangaDemonParser_1.parseViewMore)($);
    ...
    async getSearchTags() {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        return (0, MangaDemonParser_1.parseTags)($);
    }
    async getSearchResults(query, metadata) {
        ...
        const response = await this.requestManager.schedule(request, 1);
        const $ = this.cheerio.load(response.data);
        const manga = (0, MangaDemonParser_1.parseSearch)($, isTagSearch);
        return App.createPagedResults({
            results: manga,
            metadata
        });
...
exports.MangaDemon = MangaDemon;

},{"./MangaDemonParser":71,"@paperback/types":61}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
