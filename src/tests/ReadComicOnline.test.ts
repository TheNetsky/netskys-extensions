...
import { ReadComicOnline } from '../ReadComicOnline/ReadComicOnline'
...
describe('ReadComicOnline Tests', () => {
    ...
    const source: Source = new ReadComicOnline(cheerio)
   ...
   */
    const mangaId = 'The-Walking-Dead' // The-Walking-Dead
