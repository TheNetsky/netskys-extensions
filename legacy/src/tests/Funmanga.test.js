...
const Funmanga_1 = require("../Funmanga/Funmanga");
describe('Funmanga Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new Funmanga_1.Funmanga(cheerio_1.default);
     ...
     */
    var mangaId = "battle-through-the-heavens-return-of-the-beasts"; // Mashle
    ...
    it("Testing home page results for latest updated titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "latest_updates", { page: 1 }, 1);
