...
describe('ReadComicsOnline Tests', () => {
    ...
    const source: Source = new ReadComicsOnline(cheerio)
   ...
   */
    const mangaId = 'venom-lethal-protector-2022' // The-Walking-Dead
    ...
    it('Testing home page results for popular titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'latest_comic', {}, 1)
    ...
    it('Testing Notifications', async () => {
        const updates = await wrapper.filterUpdatedManga(source, new Date('2022-3-24'), [mangaId])
