...
import { ComicOnlineFree } from '../ComicOnlineFree/ComicOnlineFree'
import chai from 'chai'
import chaiAsPromised from 'chai-as-promised'

describe('ComicOnlineFree Tests', () => {

    const wrapper: APIWrapper = new APIWrapper()
    const source: Source = new ComicOnlineFree(cheerio)
   ...
   */
    const mangaId = 'cici-s-journal-the-adventures-of-a-writer-in-training' // cici-s-journal-the-adventures-of-a-writer-in-training
    ...
    it('Testing home page results for popular titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'popular', {}, 1)
    ...
    it('Testing home page results for hot titles', async () => {
        const results = await wrapper.getViewMoreItems(source, 'hot', {}, 1)
