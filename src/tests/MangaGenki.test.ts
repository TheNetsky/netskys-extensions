...
describe('MangaGenki Tests', function () {
    ...
    var source: Source = new MangaGenki(cheerio);
    ...
    it("Testing home page results for hot manga titles", async () => {
        let results = await wrapper.getViewMoreItems(source, "top_manga", {}, 1)
    ...
    it("Testing Notifications", async () => {
        let updates = await wrapper.filterUpdatedManga(source, new Date("2021-4-15"), ["giving-girl"])
