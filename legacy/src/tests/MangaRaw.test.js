...
const MangaRaw_1 = require("../MangaRaw/MangaRaw");
describe('MangaRaw Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new MangaRaw_1.MangaRaw(cheerio_1.default);
     ...
     */
    var mangaId = "shinsu-jeil-sword"; // Mashle
    ...
    it("Testing home page results for hot manga titles", () => __awaiter(this, void 0, void 0, function* () {
        let results = yield wrapper.getViewMoreItems(source, "top_manga", {}, 1);
        expect(results, "No results whatsoever for this section").to.exist;
        expect(results, "No results whatsoever for this section").to.exist;
        let data = results[0];
        expect(data.id, "No ID present").to.exist;
    ...
    it("Testing Notifications", () => __awaiter(this, void 0, void 0, function* () {
        let updates = yield wrapper.filterUpdatedManga(source, new Date("2021-3-31"), [mangaId]);
